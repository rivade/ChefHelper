...
<template>
  ...
  >
    ...
    <div
      ...
      :class="
        isMenuOpen
          ? 'max-h-[calc(100vh-130px)] translate-y-0 opacity-100 lg:max-h-none lg:opacity-100'
          : 'max-h-0 -translate-y-5 opacity-0 lg:max-h-none lg:translate-y-0 lg:opacity-100'
      "
    >
      <button
        type="button"
        ...
        :class="
          activePage === 'Hitta recept'
            ? 'lg:border-[#1a1a1a] text-black font-semibold'
      ...
      <nav class="flex w-full flex-1 flex-col items-center justify-evenly gap-1 lg:gap-0">
        ...
        <button
          ...
          :class="
            activePage === 'Skapa Recept'
              ? 'lg:border-[#1a1a1a] text-black font-semibold'
              : 'border-transparent text-black'
          "
          type="button"
          @click="
            selectPage('Skapa Recept');
            isMenuOpen = false;
          "
        >
    ...
    <div
      class="shrink-0 items-center justify-center gap-2 pt-4 text-center lg:self-stretch lg:justify-start lg:pl-1 lg:text-left"
