	...
	>
		...
		>
			...
			<nav class="flex w-full flex-1 flex-col items-center justify-evenly gap-1 lg:gap-0">
				<RouterLink
					to="/dashboard"
					class="group flex items-center justify-center gap-3 rounded-lg px-4 py-3 text-sm text-[#6b6b6b] transition duration-200 hover:bg-[#f0efe9] hover:text-black"
				...
				<button
					...
					type="button"
					@click="selectPage('Skapa Recept'); isMenuOpen = false; emit('createRecipe')"
				>
